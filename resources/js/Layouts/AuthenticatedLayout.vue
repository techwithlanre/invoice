...
watch(message, function() {
  if (message.value?.length > 0) {
    ...
    let instance = $toast.success(message.value);
    page.props.flash.message.clear;
  }
});
</script>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('product.category.index')" :active="route().current('product.category.index')">
                                  Product Categories
                                </NavLink>
